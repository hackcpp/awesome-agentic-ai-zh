...
📍 **Discipline 級概念**（6 元件 / prompt→context→harness lineage / framework vs harness）：[Stage 7 §Harness Engineering](../stages/07-multi-agent-production.md#-harness-engineering--production-agent-runtime-的工程學--本-stage-核心概念)
